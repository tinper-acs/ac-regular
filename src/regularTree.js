export default {
 ...
 
    {
        ...
        "child":[
            ...
            {"name":"零和非零开头的数字","code":"^(0|[1-9][0-9]*)$","id":"1-2","memo":"零和非零开头的数字：^(0|[1-9][0-9]*)$"},
            {"name":"非零开头的最多带两位小数的数字","code":"^([1-9][0-9]*)+(\.[0-9]{1,2})?$","id":"1-3","memo":""},
            {"name":"非零的负整数","code":"^-[1-9]\d*$","id":"1-4","memo":"小于零的负整数"},
    ...
    },
    {
        ...
        "child":[
            ...
            {"name":"英文和数字","code":"^[A-Za-z0-9]+$","id":"2-2","memo":"26个英文字母和数字组成的字符串"},
            {"name":"数字、26个英文字母或下划线组成","code":"^\w+$","id":"2-3","memo":"由数字、26个英文字母或者下划线组成的字符串"},
            {"name":"中文、英文、数字包括下划线","code":"^[\u4E00-\u9FA5A-Za-z0-9_]+$","id":"2-4","memo":"中文、英文、数字包括下划线组成字符串"},
    ...
    },
    {
        ...
        "id":"4",
        "child":[
            {"name":"手机号码","code":"^(13[0-9]|14[5|7]|15[0-9]|18[0-9])\d{8}$","id":"4-1","memo":"1568311xxxx"},
    ...
    },
    {
        ...
        "id":"6",
        "child":[
            {"name":"Email地址","code":"^[A-Za-z0-9-._]+@[A-Za-z0-9-]+(\.[A-Za-z0-9]+)*(\.[A-Za-z]{2,6})$","id":"6-1","memo":""},
